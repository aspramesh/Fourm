...
router.route('/v1/updateUser').patch(validate(paramValidation.updateUser), authenticateUser, updateUser);
router.route('/v1/updateUserPassword').patch(authenticateUser, updateUserPassword);
